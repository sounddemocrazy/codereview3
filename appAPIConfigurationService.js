...
//CuratedArticles
var CuratedArticlesAPIUrl = BASE_URL + 'articles/platformshop';

//TopArticles

var TopArticlesAPIURL = BASE_URL + 'articles/top';

//TopShop
 var TopShopAPIURL = BASE_URL + 'shops/topshops';

//Shop Banner API

var bannerAPI = BASE_URL+'shopbanners/category/id';

var forumAPI =BASE_URL + 'forum/title';
