...
var configFunction = function ($routeProvider) {
    ...
    .when('/forum',{
         templateUrl: '/Views/forum/title.html',
            controller: 'ForumController'
    })
    .when('/topShop', {
            templateUrl: '/Views/TopShops/topshop.html',
            controller: 'TopShopController'
        })
    
    .when('/topArticles', {
            templateUrl: '/Views/TopArticles/toparticles.html',
            controller: 'TopArticlesController'
        })
    .when('/curatedArticles', {
            templateUrl: '/Views/CuratedArticles/articles.html',
            controller: 'CuratedArticlesController'
        })
		.when('/portal', {
